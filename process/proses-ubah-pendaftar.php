...
$query = mysqli_query($konek, "UPDATE tb_registrasi SET nama='$nama',jenis_kelamin='$jenis_kelamin',nisn='$nisn',nkk='$nkk', nik='$nik',tempat_lahir='$tempat_lahir',tanggal_lahir='$tanggal_lahir',no_akta='$no_akta',agama='$agama',kewarganegaraan='$kewarganegaraan',kbk='$kbk',domis='$domis',almt_jl='$almt_jl',rt='$rt',nm_dsn='$nm_dsn',nm_ds='$nm_ds',nm_kec='$nm_kec',nm_kt='$nm_kt',nm_prov='$nm_prov',kode_pos='$kode_pos',tmpt_tinggal='$tmpt_tinggal',moda_transport='$moda_transport',no_kks='$no_kks',anak_ke='$anak_ke',penerima_kps='$penerima_kps',no_kps='$no_kps',lyk_pip='$lyk_pip',penerima_kip='$penerima_kip',no_kip='$no_kip',nm_kip='$nm_kip',terima_kip='$terima_kip',alasan_pip='$alasan_pip',nm_bank='$nm_bank',rek_bank='$rek_bank',nm_rek='$nm_rek',nm_ayh='$nm_ayh',glr_ayh='$glr_ayh',nik_ayh='$nik_ayh',lhr_ayh='$lhr_ayh',pnddk_ayh='$pnddk_ayh',pkrj_ayh='$pkrj_ayh',spk_ayh='$spk_ayh',pghsl_ayh='$pghsl_ayh',bk_ayh='$bk_ayh',nm_ibu='$nm_ibu',nik_ibu='$nik_ibu',lhr_ibu='$lhr_ibu',pnddk_ibu='$pnddk_ibu',pkrj_ibu='$pkrj_ibu',spk_ibu='$spk_ibu',pghsl_ibu='$pghsl_ibu',bk_ibu='$bk_ibu',nm_wali='$nm_wali',stts_wali='$stts_wali',nik_wali='$nik_wali',lhr_wali='$lhr_wali',pnddk_wali='$pnddk_wali',spk_wali='$spk_wali',pghsl_wali='$pghsl_wali',alt_wali='$alt_wali',rt_wali='$rt_wali',nm_dsn_wali='$nm_dsn_wali',nm_ds_wali='$nm_ds_wali',nm_kec_wali='$nm_kec_wali',nm_kt_wali='$nm_kt_wali',nm_prov_wali='$nm_prov_wali',kode_pos_wali='$kode_pos_wali',tlp_wali='$tlp_wali',no_rumah='$no_rumah',no_hp='$no_hp',no_wa='$no_wa',email='$email',tggi_bdn='$tggi_bdn',brt_bdn='$brt_bdn',hobi='$hobi',jarak_sekolahan='$jarak_sekolahan',tempuh_sekolahan='$tempuh_sekolahan',jml_sdr='$jml_sdr',jenis_prestasi='$jenis_prestasi',tingkat_prestasi='$tingkat_prestasi',nama_prestasi='$nama_prestasi',tahun_prestasi='$tahun_prestasi',penyelenggara_prestasi='$penyelenggara_prestasi',jns_beasiswa='$jns_beasiswa',ket_beasiswa='$ket_beasiswa',awl_beasiswa='$awl_beasiswa',akhr_beasiswa='$akhr_beasiswa',jrsn_smk='$jrsn_smk',jns_pendaftaran='$jns_pendaftaran',nis='$nis',msk_skl='$msk_skl',tgl_lulus='$tgl_lulus',d_kelas='$d_kelas',nama_smp='$nama_smp',nama_smp2='$nama_smp2',no_un='$no_un',no_ijazah='$no_ijazah',no_skhun='$no_skhun',almt_smp='$almt_smp',kota_smp='$kota_smp',prov_smp='$prov_smp',valid='$valid', v_skhun='$v_skhun',v_raport='$v_raport',v_kk='$v_kk',v_akta='$v_akta' ,v_foto='$v_foto' ,v_semua='$v_semua' WHERE id='$id' ");
$query1 = mysqli_query($konek, "UPDATE tb_siswadaftar SET no_un='$no_un', nama='$nama',nisn='$nisn', tempat_lahir='$tempat_lahir', tanggal_lahir='$tanggal_lahir', jenis_kelamin='$jenis_kelamin', agama='$agama', no_hp='$no_hp', nama_smp='$nama_smp', nama_smp2='$nama_smp2' WHERE id = '$id' ");
