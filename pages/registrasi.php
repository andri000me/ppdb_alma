				...
				<div class="panel-body">
					...
					<tr>
						...
						<tr>
								...
								<td>
									<div class="form-group">
										<input type="text" style="background: #EFFEF2" class="form-control" name="nkk" onkeyup="this.value = this.value.toUpperCase()" placeholder="Contoh Penulisan No KK 6306021809070115 (16 digit)">
									</div>
								</td>
							</tr>	
						...
						<tr>
								...
								<td>
									<div class="form-group">
										<input type="text" style="background: #EFFEF2" class="form-control" name="nik" onkeyup="this.value = this.value.toUpperCase()" placeholder="Contoh Penulisan NIK 2012787364456455 (16 digit)">
									</div>
								</td>
							</tr>		
						...
						<tr>
							...
							<td>
								<div class="form-group">
									<input type="text" class="form-control" name="tanggal_lahir" onkeyup="this.value = this.value.toUpperCase()" placeholder="tanggal - bulan - tahun (Contoh : 20/10/2003)" required oninvalid="this.setCustomValidity('data tidak boleh kosong')" oninput="setCustomValidity('')">
								</div>
							</td>
						</tr>
					</tr>
					...
					<tr>
							...
							<div class="panel-body">
								<table width="100%">
									<tr>
										...
										<td>										
											<div class="form-group">
													<input type="text" class="form-control" name="no_kks" onkeyup="this.value = this.value.toUpperCase()" placeholder="Nomor KKS (jika memiliki) berupa 6 digit kode">
											</div>											
										</td>
									</tr>
							...
							<div class="panel-body">
								<table width="100%">
									<tr>
										...
										<td>
											<div class="form-group">
												<input type="text" class="form-control" name="nm_ayh" onkeyup="this.value = this.value.toUpperCase()" placeholder="Nama Ayah">
											</div>
										</td>
									</tr>
									...
									<tr>
										...
										<td>
											<div class="form-group">
												<input type="text" class="form-control" name="glr_ayh" placeholder="Gelar yang dimiliki ayah (Contoh : S.Pd">
											</div>
										</td>
									</tr>
									...
									<tr>
										...
										<td>
											<div class="form-group">
												<input type="text" class="form-control" name="nik_ayh" onKeyPress="return goodchars(event,'0123456789.',this)" placeholder="Nomor Induk Kependudukan Ayah">
											</div>
										</td>
									</tr>
									...
									<tr>
										...
										<td>
											<div class="form-group">
												<input type="text" class="form-control" name="lhr_ayh" onKeyPress="return goodchars(event,'0123456789.',this)" placeholder="Tahun Kelahiran Ayah">
											</div>
										</td>
									</tr>
									...
									<tr>
										...
										<td>
											<div class="form-group">
												<input type="text" class="form-control" name="spk_ayh" onkeyup="this.value = this.value.toUpperCase()" placeholder="Pekerjaan sesuai dengan keadaanya sekarang">
											</div>
										</td>
									</tr>
							...
							<div class="panel-body">
								<table width="100%">
									<tr>
										...
										<td>
											<div class="form-group">
												<input type="text" class="form-control" name="nm_ibu" onkeyup="this.value = this.value.toUpperCase()" placeholder="Nama Ibu">
											</div>
										</td>
									</tr>								
									...
									<tr>
										...
										<td>
											<div class="form-group">
												<input type="text" class="form-control" name="nik_ibu" onKeyPress="return goodchars(event,'0123456789.',this)" placeholder="Nomor Kependudukan Ibu">
											</div>
										</td>
									</tr>
									...
									<tr>
										...
										<td>
											<div class="form-group">
												<input type="text" class="form-control" name="lhr_ibu" onKeyPress="return goodchars(event,'0123456789.',this)" placeholder="Tahun Kelahiran Ibu">
											</div>
										</td>
									</tr>
									...
									<tr>
										...
										<td>
											<div class="form-group">
												<input type="text" class="form-control" name="spk_ibu" onkeyup="this.value = this.value.toUpperCase()" placeholder="Pekerjaan sesuai dengan keadaanya sekarang">
											</div>
										</td>
									</tr>
						...
						<div class="panel panel-primary">
							...
							<tr>
								<th>
									<label for="no_hp">Nomor HP Ortu *</label>
								</th>
								<td>
									<div class="form-group">
										<input type="text" class="form-control" style="background: #E6E6FA" name="no_hp" placeholder="Nomor HP yang bisa dihubungi">
									</div>
								</td>
							</tr>
							...
							<tr>
								...
								<td>
									<div class="form-group">
										<input type="text" class="form-control" style="background: #E6E6FA" name="no_wa" placeholder="Nomor HP yang bisa di Whatsapp">
									</div>
								</td>
							</tr>
											...
											<table width="100%">
												...
												<tr>
													<th>
														...
														<td>
															<div class="form-group">
															<input type="text" class="form-control" name="tgl_lulus" onkeyup="this.value = this.value.toUpperCase()" placeholder="Tanggal Kelulusan SMP/MTS" >
															</div>
														</td>
												</tr>
...
// tampilkan query
									...
									<tr>
										...
										<td>
											<div class="form-group">
												<input type="text" class="form-control" style="background: #FDD7D7" name="nama_smp2" onkeyup="this.value = this.value.toUpperCase()" placeholder="Hanya diisi jika nama SMP/MTS tidak ada dalam daftar di atas">
											</div>
										</td>
									</tr>
													...
													<tr>
														...
														<td>
															<div class="form-group">
																<input type="text" class="form-control" style="background: #EFFEF2" name="no_un" onkeyup="this.value = this.value.toUpperCase()" placeholder="Contoh Penulisan 2-15-15-11-028-037-4 (kalau angka yang pertama nol, maka diberi tanda titik atau min setelah angka pertama)">
															</div>
														</td>
													</tr>														
													...
													<td>
														<div class="form-group">
														<input type="text" class="form-control" name="no_ijazah" onKeyPress="this.value = this.value.toUpperCase()" placeholder="Di isi oleh petugas administrasi sekolah (kalau angka yang pertama nol, maka diberi tanda titik atau min setelah angka pertama)">
														</div>
													</td>
													</tr>
													...
													<td>
														<div class="form-group">
														<input type="text" class="form-control" name="no_skhun" onKeyPress="this.value = this.value.toUpperCase()" placeholder="Di isi oleh petugas administrasi sekolah (kalau angka yang pertama nol, maka diberi tanda titik atau min setelah angka pertama)">
														</div>
													</td>
													</tr>
													...
													<tr>
														...
														<td>
														<div class="form-group">
															<input type="text" class="form-control" style="background: #EFFEF2" name="almt_smp" onkeyup="this.value = this.value.toUpperCase()" placeholder="Alamat SMP/MTS">
														</div>
													</td>
													</tr>
													...
													<tr>
														...
														<td>
														<div class="form-group">
															<input type="text" class="form-control" style="background: #EFFEF2" name="kota_smp" onkeyup="this.value = this.value.toUpperCase()" placeholder="Kota/Kabupaten SMP/MTS Berada">
														</div>
													</td>
													</tr>
													...
													<tr>
														...
														<td>
														<div class="form-group">
															<input type="text" class="form-control" style="background: #EFFEF2" name="prov_smp" onkeyup="this.value = this.value.toUpperCase()" placeholder="Provinsi SMP/MTS Berada">
														</div>
													</td>
													</tr>
